...
describe('Discrete task manager', function () {
  ...
  describe('Get resource', function () {
    ...
    it('Fails to get non existing discrete task', async function () {
      ...
      try {
        ...
        expect(await discreteTaskManager.getDiscreteTask(discreteTaskGet.params)).toThrow(EntityGetError);
      } catch (err) {
        jest.fn();
      }
  ...
  describe('Delete resource', function () {
    ...
    it('Fails to delete non existing discrete task', async function () {
      ...
      try {
        // TODO: replace with custom error
        expect(await discreteTaskManager.deleteDiscreteTask(discreteTaskDeleteError.params)).toThrow(Error);
      } catch (err) {
        jest.fn();
      }
